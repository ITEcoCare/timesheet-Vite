...
const TableTimesheet = ({ columns, data }) => {
    ...
    const runRejected = (_, record) => {
        ...
        // if (alert('are you sure you want to approve these?')) {
        //     approveTimesheet(accessToken, record);
        // }
    }
            ...
            render: (_, record) => {
                ...
                return (
                    <>
                        <Button
                            type="secondary"
                            className="mr-1 border-b-4 rounded-lg  border-b-yellow-400 font-bold bg-yellow-300 text-stone-100"
                            onClick={() => {
                        ...
                        <Button
                            type="secondary"
                            className="mr-1 border-b-4 rounded-lg border-b-red-600 font-bold bg-red-400 text-stone-100"
                            onClick={() => {
                                runDelete(_, record)
                            }}
                        >
                            {/* <img className="bg-blue-500" src="http://www.w3.org/2000/svg" alt="" /> */}
                        ...
                        { userData.employee_lead && <Button
                                type="secondary"
                                className="mr-1 border-b-4 rounded-lg  border-b-green-600 font-bold bg-green-400 text-stone-100"
                                onClick={() => {
                                    runApprove(_, record)
                                }}
                            > 
                        ...
                        { userData.employee_lead && <div className=''>
                                <div className='w-6 relative before:z-10 before:absolute before:left-1/2 before:-top-3 before:w-max before:max-w-xs before:-translate-x-1/2 before:-translate-y-full before:rounded-lg before:bg-gray-700 before:px-2 before:py-1.5 before:text-white before:invisible before:content-[attr(data-tip)] after:z-10 after:absolute after:left-1/2 after:-top-3 after:h-0 after:w-0 after:-translate-x-1/2 after:border-8 after:border-t-gray-700 after:border-l-transparent after:border-b-transparent after:border-r-transparent after:invisible hover:before:visible hover:after:visible'
                                    ...
                                    className='mr-1 p-2 border-b-4 rounded-lg  border-b-red-600 font-bold bg-red-400 text-stone-100 hover:border-red-900 hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2'>
            ...
            <div className="grid md:grid-cols-3 gap-8">
                <div className="items-center justify-center hidden col-span-3 space-x-2 sm:flex">
                    ...
                    {/* <form form={form} className=" rounded-2xl"> */}
                        ...
                        <select
                            className={"fill-white dark:bg-stone-800 hover:bg-white-400  mr-4 py-2 px-4 border-b-4 dark:border-stone-900 border-gray-200 rounded-r-xl shadow-inner hover:bg-gray-100 "}
                            // onChange={(e) => { onFilteredEmploy(accessToken, e.target.value) }}
                            onChange={formik.handleChange}
                            id="employee_id"
                            name="employee_id"
                ...
                <div className="bg-stone-100 dark:bg-stone-800 dark:border-b-stone-600 border-b-gray-400 border-b-4 rounded-xl border-stone-200 dark:border-stone-700 p-4 md:p-8">
                ...
                <div className=" overflow-y-scroll h-[450px] bg-stone-100 dark:bg-stone-800 dark:border-b-stone-600 border-b-gray-400 border-b-4 rounded-xl border-stone-200 dark:border-stone-700 md:p-8">
                ...
                <div className="grid grid-cols-3">
                    ...
                    <div className="col-span-1 flex justify-end">
                        <button
                            ...
                            className=" items-baseline py-2 px-4   cursor-pointer bg-red-500 hover:bg-red-400 text-white font-bold border-b-4 border-red-700 hover:border-red-500 rounded-xl hover:shadow-inner transition duration-200 ease-in-out  transform hover:-translate-x hover:scale-105"
                        >
                            Submit!
                        </button>
                    </div>
